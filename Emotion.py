...
font = ('times', 20, 'bold')
title = Label(main, text='Lets match your emotion with some music')
title.config(bg='light blue', fg='#4F1C51')  
...
pathlabel.config(bg='light blue', fg='white')  
...
emotionlabel.config(bg='maroon', fg='white')  
